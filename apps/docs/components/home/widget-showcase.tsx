...
import { CalendarWidget, CompactCalendarWidget } from "@einui/registry";
import {
  AnalogClockWidget,
  DigitalClockWidget,
  StopwatchWidget,
} from "@einui/registry";
import { StockTickerWidget } from "@einui/registry";
import { HourlyWeatherWidget, ForecastWidget } from "@einui/registry";
