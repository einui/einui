...
- Purpose: `GlassSkeleton` is a `Feedback` component in Ein UI.
...
Verified source: `registry/liquid-glass/glass-skeleton.tsx`
...
`GlassSkeleton` is complete only if:
