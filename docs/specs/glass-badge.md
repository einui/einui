...
- Purpose: `GlassBadge` is a `Data Display` component in Ein UI.
- Current maturity: `Low-Medium`.
- Current score from COMPONENT_AUDIT.md: `55 / 100`.
...
Verified source: `registry/liquid-glass/glass-badge.tsx`
...
`GlassBadge` is complete only if:
