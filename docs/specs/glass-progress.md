...
- Purpose: `GlassProgress` is a `Feedback` component in Ein UI.
...
Verified source: `registry/liquid-glass/glass-progress.tsx`
...
`GlassProgress` is complete only if:
