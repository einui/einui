...
- Purpose: `GlassSpotlight` is a `Overlay` component in Ein UI.
- Current maturity: `Medium`.
- Current score from COMPONENT_AUDIT.md: `54 / 100`.
...
Verified source: `registry/innovative/glass-spotlight.tsx`
...
`GlassSpotlight` is complete only if:
