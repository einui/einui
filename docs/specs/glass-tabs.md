...
- Purpose: `GlassTabs` is a `Navigation` component in Ein UI.
- Current maturity: `Low-Medium`.
- Current score from COMPONENT_AUDIT.md: `53 / 100`.
...
Verified source: `registry/liquid-glass/glass-tabs.tsx`
