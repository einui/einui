...
- Purpose: `GlassTable` is a `Data Display` component in Ein UI.
- Current maturity: `Low`.
- Current score from COMPONENT_AUDIT.md: `44 / 100`.
...
Verified source: `registry/liquid-glass/glass-table.tsx`
...
`GlassTable` is complete only if:
