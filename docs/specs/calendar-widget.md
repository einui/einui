...
- Purpose: `CalendarWidget` is a `Data Display` component in Ein UI.
...
Verified source: `registry/widgets/calendar-widget.tsx`
...
`CalendarWidget` is complete only if:
