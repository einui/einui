...
- Purpose: `ClockWidget` is a `Data Display` component in Ein UI.
...
Verified source: `registry/widgets/clock-widget.tsx`
...
`ClockWidget` is complete only if:
