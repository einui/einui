...
- Purpose: `GlassBreadcrumb` is a `Navigation` component in Ein UI.
...
Verified source: `registry/liquid-glass/glass-breadcrumb.tsx`
...
`GlassBreadcrumb` is complete only if:
