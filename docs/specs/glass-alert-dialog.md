...
- Purpose: `GlassAlertDialog` is a `Overlay` component in Ein UI.
- Current maturity: `Low`.
- Current score from COMPONENT_AUDIT.md: `50 / 100`.
...
Verified source: `registry/liquid-glass/glass-alert-dialog.tsx`
...
`GlassAlertDialog` is complete only if:
