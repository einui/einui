...
- Purpose: `BaseWidget` is a `Data Display` component in Ein UI.
- Current maturity: `Low`.
- Current score from COMPONENT_AUDIT.md: `45 / 100`.
...
Verified source: `registry/widgets/base-widget.tsx`
...
`BaseWidget` is complete only if:
