...
- Purpose: `GlassAvatar` is a `Data Display` component in Ein UI.
...
Verified source: `registry/liquid-glass/glass-avatar.tsx`
...
`GlassAvatar` is complete only if:
