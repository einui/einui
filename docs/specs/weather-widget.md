...
- Purpose: `WeatherWidget` is a `Data Display` component in Ein UI.
...
Verified source: `registry/widgets/weather-widget.tsx`
...
`WeatherWidget` is complete only if:
