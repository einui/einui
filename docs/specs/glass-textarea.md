...
- Purpose: `GlassTextarea` is a `Form` component in Ein UI.
- Current maturity: `Low-Medium`.
- Current score from COMPONENT_AUDIT.md: `52 / 100`.
...
Verified source: `registry/liquid-glass/glass-textarea.tsx`
...
`GlassTextarea` is complete only if:
